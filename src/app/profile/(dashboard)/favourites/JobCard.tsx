        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              >
                {
                  jobTypes.find((job) => job.key.includes(jobPost.jobType))
                    ?.label
                }
              </Badge>
              <Badge
              ...
              >
                {
                  workModes.find((job) => job.key.includes(jobPost.workMode))
                    ?.label
                }
              </Badge>
              <Badge variant="outline">
                {
                  experienceLevels.find((job) =>
